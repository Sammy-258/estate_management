        ...
        <div class="row py-5">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="d-block py-4">
                    <div class="d-flex">
                        <div class="design-blocks"></div>
                        <div class="design-blocks"></div>
                    </div>
                    <span style="font-size:10px;">Welcome Customer</span>
                    <div class="d-block welcoming-main-text-d-block pt-5">
                        <P class="welcoming-main-text">Find Your Next Perfect Place TO live</P>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Numquam nisi, fugiat sint ad eos explicabo laboriosam, delectus natus rem eum architecto ea tempore, illo quos quod reprehenderit magni dolores debitis.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container-fluid my-5">
        <div class="row px-lg-5 gy-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center m-0">
                        <p class="m-0 fs-6">Sort By</p>
                        <select name="" id="sort-by" class="m-0 px-3 mx-2 py-2 rounded-3">
                            <option value="selected" selected>Default</option>
                            <option value="land" >landed Property</option>
                            <option value="house" >House Property</option>
                            <option value="others" >Other Property</option>
                        </select>
                    </div>
                </div>
            </div>
            <?php
                ...
                $sql="SELECT * FROM `pro_table` WHERE `where`='buy'";
                    ...
                    <div class="card-body p-0 px-2 shadow py-1">
                        ...
                        <div class="card-text-describe">
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-2 pt-lg-0 pt-md-0">
                                ...
                                <a href="enquire.php?id=<?php echo $row["id"]?>" class="btn btn-general m-0 px-4 py-1 text-light enquire-btn" style="text-decoration:none;">Enquire now</a>
                            </div>
                        </div>
                    </div>
                </div>
